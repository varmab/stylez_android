...
public class Facebook {
    ...
    public static final Uri ATTRIBUTION_ID_CONTENT_URI =
        Uri.parse("content://com.stylez.activities.provider.AttributionIdProvider");
    @Deprecated
    ...
    public void authorize(Activity activity, final DialogListener listener) {
        authorize(activity, new String[]{}, -1, SessionLoginBehavior.SSO_WITH_FALLBACK,
                listener);
    }
    ...
    public void authorize(Activity activity, String[] permissions, final DialogListener listener) {
        authorize(activity, permissions, -1, SessionLoginBehavior.SSO_WITH_FALLBACK, listener);
    }
    ...
    public boolean extendAccessToken(Context context, ServiceListener serviceListener) {
        ...
        intent.setClassName("com.stylez.activities", "com.stylez.activities.platform.TokenRefreshService");
